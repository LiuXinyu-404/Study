.data
	array:.space 400
	message_input_n:.asciiz"please input integer as athe length of the sequence:\n"
	message_input_array:.asciiz"please input an integer tollowed with a line break::\n"
