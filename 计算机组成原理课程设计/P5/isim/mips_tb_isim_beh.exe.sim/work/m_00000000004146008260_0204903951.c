...
#endif
static const char *ng0 = "C:/Computer/P5/Ctrl.v";
...
LAB105:    xsi_set_current_line(139, ng0);
    t2 = (t0 + 1048U);
    t3 = *((char **)t2);
    t2 = ((char*)((ng12)));
    memset(t6, 0, 8);
...
LAB128:    *((unsigned int *)t34) = 1;

LAB130:    memset(t50, 0, 8);
    t51 = (t34 + 4);
    t52 = *((unsigned int *)t51);
    t53 = (~(t52));
    t54 = *((unsigned int *)t34);
...
LAB164:    xsi_set_current_line(169, ng0);
...
extern void work_m_00000000004146008260_0204903951_init()
{
	static char *pe[] = {(void *)Always_46_0};
	xsi_register_didat("work_m_00000000004146008260_0204903951", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000004146008260_0204903951.didat");
